...
class PatchmatchNet(nn.Module):
    def __init__(self, patchmatch_interval_scale = [0.005, 0.01, 0.02], propagation_range = [7,5,3],
                patchmatch_iteration = [1,1,2], patchmatch_num_sample = [3,5,5], propagate_neighbors = [8,8,8],
