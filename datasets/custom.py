...
class MVSDataset(Dataset):
    ...
    def build_metas(self):
        self.metas = []
        with open(os.path.join(self.data_path, 'pair.txt')) as f:
    ...
    def __getitem__(self, idx):
        ...
        for i, vid in enumerate(view_ids):
            ...
            intrinsics, extrinsics, depth_min_, depth_max_ = read_cam_file(proj_mat_filename)
            intrinsics[0] *= self.img_dims[0] / original_w
            intrinsics[1] *= self.img_dims[1] / original_h
        ...
        imgs = {'stage_0': imgs_0, 'stage_1': imgs_1, 'stage_2': imgs_2, 'stage_3': imgs_3}
        # proj_matrices: N*4*4
        ...
        proj = {'stage_3': proj_matrices_3, 'stage_2': proj_matrices_2, 'stage_1': proj_matrices_1,
                'stage_0': proj_matrices_0}
